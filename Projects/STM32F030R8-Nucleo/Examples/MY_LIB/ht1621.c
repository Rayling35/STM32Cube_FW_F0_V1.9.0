...
#define  CS_LOW        C5_OUTPUT_LOW()
#define  CS_HIGH       C5_OUTPUT_HIGH()
#define  WR_LOW        C6_OUTPUT_LOW()
#define  WR_HIGH       C6_OUTPUT_HIGH()
#define  DATA_LOW      C8_OUTPUT_LOW()
#define  DATA_HIGH     C8_OUTPUT_HIGH()
