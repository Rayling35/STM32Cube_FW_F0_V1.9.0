...
static int spi1_cs0_transmit(uint8_t *data, uint16_t length, uint32_t timeout)
{
	...
	SPI1C0_LOW();
	e_status = HAL_SPI_Transmit(&SpiHandle1, data, length, timeout);
	SPI1C0_HIGH();
	if(e_status != HAL_OK) {
		spi1_cs0_error();
	}
...
static int spi1_cs0_receive(uint8_t *data, uint16_t length, uint32_t timeout)
{
	HAL_StatusTypeDef e_status = HAL_OK;
	SPI1C0_LOW();
	e_status = HAL_SPI_Receive(&SpiHandle1, data, length, timeout);
	SPI1C0_HIGH();
	if(e_status != HAL_OK) {
		spi1_cs0_error();
	}
...
static int spi1_cs0_receive32(uint32_t *data, uint16_t length, uint32_t timeout)
{
	...
	for(i = 0; i < length; i++) {
		SPI1C0_LOW();
		e_status = HAL_SPI_Receive(&SpiHandle1, rx_data, 4, timeout);
		SPI1C0_HIGH();
...
static int spi1_cs0_transmit_receive(uint8_t *tx_data, uint8_t *rx_data, uint16_t length, uint32_t timeout)
{
	HAL_StatusTypeDef e_status = HAL_OK;
	SPI1C0_LOW();
	e_status = HAL_SPI_TransmitReceive(&SpiHandle1, tx_data, rx_data, length, timeout);
	SPI1C0_HIGH();
	if(e_status != HAL_OK) {
		spi1_cs0_error();
	}
...
static int spi1_cs0_transmit_it(uint8_t *data, uint16_t length)
{
	HAL_StatusTypeDef e_status = HAL_OK;
	SPI1C0_LOW();
	e_status = HAL_SPI_Transmit_IT(&SpiHandle1, data, length);
	SPI1C0_HIGH();
	if(e_status != HAL_OK) {
		spi1_cs0_error();
	}
...
static int spi1_cs0_receive_it(uint8_t *data, uint16_t length)
{
	HAL_StatusTypeDef e_status = HAL_OK;
	SPI1C0_LOW();
	e_status = HAL_SPI_Receive_IT(&SpiHandle1, data, length);
	SPI1C0_HIGH();
	if(e_status != HAL_OK) {
		spi1_cs0_error();
	}
...
static int spi1_cs0_transmit_receive_it(uint8_t *tx_data, uint8_t *rx_data, uint16_t length)
{
	HAL_StatusTypeDef e_status = HAL_OK;
	SPI1C0_LOW();
	e_status = HAL_SPI_TransmitReceive_IT(&SpiHandle1, tx_data, rx_data, length);
	SPI1C0_HIGH();
	if(e_status != HAL_OK) {
		spi1_cs0_error();
	}
...
static int spi1_cs0_transmit_dma(uint8_t *data, uint16_t length)
{
	HAL_StatusTypeDef e_status = HAL_OK;
	SPI1C0_LOW();
	e_status = HAL_SPI_Transmit_DMA(&SpiHandle1, data, length);
	SPI1C0_HIGH();
	if(e_status != HAL_OK) {
		spi1_cs0_error();
	}
...
static int spi1_cs0_receive_dma(uint8_t *data, uint16_t length)
{
	HAL_StatusTypeDef e_status = HAL_OK;
	SPI1C0_LOW();
	e_status = HAL_SPI_Receive_DMA(&SpiHandle1, data, length);
	SPI1C0_HIGH();
	if(e_status != HAL_OK) {
		spi1_cs0_error();
	}
...
static int spi1_cs0_transmit_receive_dma(uint8_t *tx_data, uint8_t *rx_data, uint16_t length)
{
	HAL_StatusTypeDef e_status = HAL_OK;
	SPI1C0_LOW();
	e_status = HAL_SPI_TransmitReceive_DMA(&SpiHandle1, tx_data, rx_data, length);
	SPI1C0_HIGH();
	if(e_status != HAL_OK) {
		spi1_cs0_error();
	}
